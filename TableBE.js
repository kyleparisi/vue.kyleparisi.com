...
Vue.component("table-component", {
  template: `<div>
    <div class="overflow-auto">
        ...
        <table class="f6 collapse pv2 ph3 w-100">
            ...
            <!-- Body -->
            <template v-if="data">
                <template v-for="(row, row_id) in data">
            ...
            <template v-if="_.size(data) && _.size(data) < 10">
    ...
    <div>
        <!-- Pagination -->
        <div class="flex items-center f6 pv3 bg-white" v-if="count >= pageSize">
            ...
            <!-- Page selector -->
            <div class="w-50 tc">
                <div class="dib overflow-hidden ba br2 b--near-black" v-if="count >= pageSize">
                    <nav class="cf">
  ...
  computed: {
    paginationLayout: {
      get: function() {
        return paginationLayout(this.count, this.pageSize, this.page);
      }
    },
    allSelected: {
      get: function() {
